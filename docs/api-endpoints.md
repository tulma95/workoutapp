...
- `GET /api/users/me/export` — returns all the user's data (profile, training maxes, workouts+sets, plans, achievements) as JSON with a `Content-Disposition: attachment` header for download
